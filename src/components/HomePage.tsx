    ...
    <div className="h-screen w-full flex justify-center" id="home-section">
        <div className='container mt-60 mb-52 w-full flex flex-col lg:flex-row items-center lg:items-center  lg:justify-between'>
            ...
            <div>
                ...
                <Link  href={"/store"} >
                <button className='relative  z-10 duration-300 text-stickeryellow py-3 md:py-3 rounded-md px-5 md:px-10 lg:px-0 lg:w-1/4 text-xs lg:text-xl bg-stickered mt-5 font-bold hover:bg-stickeryellow hover:text-stickered'>
                        Go To Store
                </button>
                </Link>
                <ScrollLink
                ...
                >
                <button className='relative  z-10 duration-300 text-stickeryellow py-3 md:py-3 rounded-md px-5 md:px-10 lg:px-0 lg:w-1/4 text-xs lg:text-xl ml-4 bg-stickered mt-5 font-bold hover:bg-stickeryellow hover:text-stickered'>
                        Collection & Services
                </button>
                </ScrollLink>
                </div>
